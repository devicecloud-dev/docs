...
**Important:** Using Maestro-based onboarding **will slow your test suite down**. We therefore only recommend using it if you are experiencing issues with the default config-based method.
