...
Uploads (both binaries and workflow files) are automatically deleted 2 months after last use; result data including maestro logs, screenshots and videos are retained for 6 months. All account data is permanently deleted when you request account deletion. This can be done by contacting support or through the console UI.
